...
#if ROLLUP1_OPENING_PIN != OFF && (ROLLUP1_OPENING_PIN == ROLLUP1_CLOSING_PIN ||ROLLUP1_OPENING_PIN == ROLLUP2_CLOSING_PIN || ROLLUP1_OPENING_PIN == ROLLUP2_OPENING_PIN || ROLLUP1_OPENING_PIN == DEVICE1_PIN || ROLLUP1_OPENING_PIN == DEVICE2_PIN || ROLLUP1_OPENING_PIN == ALARM_PIN)
  #error Rollup1 opening pin attributed to other output
#endif

#if ROLLUP1_CLOSING_PIN != OFF  && (ROLLUP1_CLOSING_PIN == ROLLUP1_OPENING_PIN ||ROLLUP1_CLOSING_PIN == ROLLUP2_CLOSING_PIN || ROLLUP1_CLOSING_PIN == ROLLUP2_OPENING_PIN || ROLLUP1_CLOSING_PIN == DEVICE1_PIN || ROLLUP1_CLOSING_PIN == DEVICE2_PIN || ROLLUP1_CLOSING_PIN == ALARM_PIN)
  #error Rollup1 closing pin attributed to other output
#endif

#if ROLLUP2_OPENING_PIN != OFF && (ROLLUP2_OPENING_PIN == ROLLUP1_CLOSING_PIN ||ROLLUP2_OPENING_PIN == ROLLUP2_CLOSING_PIN || ROLLUP2_OPENING_PIN == ROLLUP1_OPENING_PIN  || ROLLUP2_OPENING_PIN == DEVICE1_PIN || ROLLUP2_OPENING_PIN == DEVICE2_PIN || ROLLUP2_OPENING_PIN == ALARM_PIN)
  #error Rollup2 opening pin attributed to other output
#endif

#if ROLLUP2_CLOSING_PIN != OFF  && (ROLLUP2_CLOSING_PIN == ROLLUP1_CLOSING_PIN ||ROLLUP2_CLOSING_PIN == ROLLUP1_OPENING_PIN || ROLLUP2_CLOSING_PIN == ROLLUP2_OPENING_PIN || ROLLUP2_CLOSING_PIN == DEVICE1_PIN || ROLLUP2_CLOSING_PIN == DEVICE2_PIN || ROLLUP2_CLOSING_PIN == ALARM_PIN)
